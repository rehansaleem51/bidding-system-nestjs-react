...
export default function UserRegistration() {
  ...
  const schema = yup.object().shape({
      ...
      user: yup.object().shape({
          ...
          department_id: yup.number().required('Department Address is required'),
...
useEffect(() => {
  ...
  const getSubmitHandler = () => (values) => {
      setIsLoading(true);
      UserService.edit(values.user, id).then(response => {
  ...
  return (
    ...
    <div className='contentHeader mb-4'>
        <Row>
            <Col md={12}>
                <h3 className='contentTitle'>User Update</h3>
            </Col>
        </Row>
    </div>
    <Row>
            ...
            <Card.Body>
              ...
              <Col lg={4} md={6}>
                <Form.Group className="mb-4" controlId="exampleForm.ControlInput1">
                  ...
                  <Form.Select value={values.user.type} onChange={handleChange} name="user.type" aria-label="Default select example">
              ...
              <Form.Group className="mb-4" controlId="exampleForm.ControlInput1">
                ...
                <Form.Select value={values.user.department_id} onChange={handleChange} name="user.department_id" aria-label="Default select example">
                    <option>Select Department</option>
                    <option value="1">One</option>
                    <option value="2">Two</option>
                    <option value="3">Three</option>
                </Form.Select>
                {errors.user?.department_id && touched.user?.department_id && (
                                <div className="text-danger">{errors.user?.department_id}</div>
                            )}
              </Form.Group>
              </Col>
              <Col lg={4} md={6}>
              <Form.Group className="mb-4" controlId="exampleForm.ControlInput1">
                ...
                <Form.Select value={values.user.designation_id} onChange={handleChange} name="user.designation_id" aria-label="Default select example">
                    <option>Select Designation</option>
                    <option value="1">One</option>
                    <option value="2">Two</option>
                    <option value="3">Three</option>
                </Form.Select>
                {errors.user?.designation_id && touched.user?.designation_id && (
                                <div className="text-danger">{errors.user?.designation_id}</div>
                            )}
              </Form.Group>
              </Col>
              <Col lg={4} md={6}>
              <Form.Group className="mb-4" controlId="exampleForm.ControlInput1">
                  ...
                  <Form.Control value={values.user.name} onChange={handleChange} name="user.name" type="text" placeholder="Enter Name" />
              ...
              <Form.Group className="mb-4" controlId="exampleForm.ControlInput1">
                  ...
                  <Form.Control value={values.user.email} onChange={handleChange} name="user.email" type="email" placeholder="xyz@gmail.com" />
              ...
              <Form.Group className="mb-4" controlId="exampleForm.ControlInput1">
                  ...
                  <Form.Select value={values.user.status} onChange={handleChange} name="user.status" aria-label="Default select example">
